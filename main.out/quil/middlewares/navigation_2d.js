...
return cljs.core.merge.call(null,initial_state,p1__20699_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_20700 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_20701 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_20700);
var pos_20702 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_20700);
quil.core.scale.call(null,zoom_20701);

var tr__20623__auto___20703 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_20701) - cljs.core.first.call(null,pos_20702)),(((quil.core.height.call(null) / (2)) / zoom_20701) - cljs.core.second.call(null,pos_20702))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__20623__auto___20703);
