...
var vec__20213 = axis;
var a_x = cljs.core.nth.call(null,vec__20213,(0),null);
var a_y = cljs.core.nth.call(null,vec__20213,(1),null);
var a_z = cljs.core.nth.call(null,vec__20213,(2),null);
var vec__20214 = v;
var x = cljs.core.nth.call(null,vec__20214,(0),null);
var y = cljs.core.nth.call(null,vec__20214,(1),null);
var z = cljs.core.nth.call(null,vec__20214,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__20215,p__20216){
var vec__20219 = p__20215;
var u1 = cljs.core.nth.call(null,vec__20219,(0),null);
var u2 = cljs.core.nth.call(null,vec__20219,(1),null);
var u3 = cljs.core.nth.call(null,vec__20219,(2),null);
var vec__20220 = p__20216;
var v1 = cljs.core.nth.call(null,vec__20220,(0),null);
var v2 = cljs.core.nth.call(null,vec__20220,(1),null);
var v3 = cljs.core.nth.call(null,vec__20220,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__20221_SHARP_){
return (p1__20221_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__20222_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__20223_SHARP_,angle_lr),angle_ud);
...
var map__20230 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__20230__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__20230__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__20232 = cljs.core._EQ_;
var expr__20233 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__20232.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__20233))){
return straight;
} else {
if(cljs.core.truth_(pred__20232.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__20233))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__20232.call(null,quil.middlewares.navigation_3d.space,expr__20233))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__20232.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__20233))){
return up;
} else {
if(cljs.core.truth_(pred__20232.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__20233))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__20232.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__20233))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__20230,map__20230__$1,up,straight){
return (function (p1__20224_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__20224_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__20230,map__20230__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__20235_SHARP_);
});})(initial_state))
);
});
/**
...
var map__20241_20246 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__20241_20247__$1 = ((((!((map__20241_20246 == null)))?((((map__20241_20246.cljs$lang$protocol_mask$partition0$ & (64))) || (map__20241_20246.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20241_20246):map__20241_20246);
var vec__20242_20248 = cljs.core.get.call(null,map__20241_20247__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_20249 = cljs.core.nth.call(null,vec__20242_20248,(0),null);
var c_y_20250 = cljs.core.nth.call(null,vec__20242_20248,(1),null);
var c_z_20251 = cljs.core.nth.call(null,vec__20242_20248,(2),null);
var vec__20243_20252 = cljs.core.get.call(null,map__20241_20247__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_20253 = cljs.core.nth.call(null,vec__20243_20252,(0),null);
var u_y_20254 = cljs.core.nth.call(null,vec__20243_20252,(1),null);
var u_z_20255 = cljs.core.nth.call(null,vec__20243_20252,(2),null);
var vec__20244_20256 = cljs.core.get.call(null,map__20241_20247__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_20257 = cljs.core.nth.call(null,vec__20244_20256,(0),null);
var p_y_20258 = cljs.core.nth.call(null,vec__20244_20256,(1),null);
var p_z_20259 = cljs.core.nth.call(null,vec__20244_20256,(2),null);
quil.core.camera.call(null,p_x_20257,p_y_20258,p_z_20259,(p_x_20257 + c_x_20249),(p_y_20258 + c_y_20250),(p_z_20259 + c_z_20251),u_x_20253,u_y_20254,u_z_20255);
