...
var _STAR_data_readers_STAR_20743 = cljs.tools.reader._STAR_data_readers_STAR_;
...
var eof = {};
var read = ((function (rr,eof,_STAR_data_readers_STAR_20743){
return (function (){
...
});})(rr,eof,_STAR_data_readers_STAR_20743))
;
var last_pos = (0);
var second_pos = (0);
var last_form = null;
...
var G__20746 = new_pos;
var G__20747 = last_pos;
var G__20748 = form;
var G__20749 = last_form;
last_pos = G__20746;
second_pos = G__20747;
last_form = G__20748;
second_form = G__20749;
continue;
}
break;
}
}finally {cljs.tools.reader._STAR_data_readers_STAR_ = _STAR_data_readers_STAR_20743;
}});
...
while (G__20750__i < G__20750__a.length) {G__20750__a[G__20750__i] = arguments[G__20750__i + 0]; ++G__20750__i;}
  b = new cljs.core.IndexedSeq(G__20750__a,0);
} 
return reepl$replumb$jsc_run_$_a__delegate.call(this,b);};
reepl$replumb$jsc_run_$_a.cljs$lang$maxFixedArity = 0;
reepl$replumb$jsc_run_$_a.cljs$lang$applyTo = (function (arglist__20751){
var b = cljs.core.seq(arglist__20751);
...
var _STAR_data_readers_STAR_20753 = cljs.tools.reader._STAR_data_readers_STAR_;
cljs.tools.reader._STAR_data_readers_STAR_ = cljs.tagged_literals._STAR_cljs_data_readers_STAR_;
...
}finally {cljs.tools.reader._STAR_data_readers_STAR_ = _STAR_data_readers_STAR_20753;
}});
reepl.replumb.run_repl_multi = (function reepl$replumb$run_repl_multi(text,opts,cb){
var text__$1 = text.trim();
var vec__20756 = reepl.replumb.get_first_form.call(null,text__$1);
var form = cljs.core.nth.call(null,vec__20756,(0),null);
var pos = cljs.core.nth.call(null,vec__20756,(1),null);
...
return replumb.core.read_eval_call.call(null,opts,((function (text__$1,vec__20756,form,pos,source,remainder,has_more_QMARK_){
return (function (p1__20754_SHARP_){
var success_QMARK_ = replumb.core.success_QMARK_.call(null,p1__20754_SHARP_);
var result = replumb.core.unwrap_result.call(null,p1__20754_SHARP_);
...
});})(text__$1,vec__20756,form,pos,source,remainder,has_more_QMARK_))
,source);
});
...
return cb.call(null,replumb.core.success_QMARK_.call(null,p1__20757_SHARP_),replumb.core.unwrap_result.call(null,p1__20757_SHARP_));
});})(fixed))
,text);
}
});
reepl.replumb.fix_ns_do = (function reepl$replumb$fix_ns_do(text){
var _STAR_data_readers_STAR_20759 = cljs.tools.reader._STAR_data_readers_STAR_;
cljs.tools.reader._STAR_data_readers_STAR_ = cljs.tagged_literals._STAR_cljs_data_readers_STAR_;
...
}finally {cljs.tools.reader._STAR_data_readers_STAR_ = _STAR_data_readers_STAR_20759;
}});
reepl.replumb.run_repl_STAR_ = (function reepl$replumb$run_repl_STAR_(text,opts,cb){
return replumb.core.read_eval_call.call(null,opts,(function (p1__20760_SHARP_){
return cb.call(null,replumb.core.success_QMARK_.call(null,p1__20760_SHARP_),replumb.core.unwrap_result.call(null,p1__20760_SHARP_));
}),reepl.replumb.fix_ns_do.call(null,text));
});
reepl.replumb.run_repl = (function reepl$replumb$run_repl(var_args){
var args20761 = [];
var len__7511__auto___20764 = arguments.length;
var i__7512__auto___20765 = (0);
while(true){
if((i__7512__auto___20765 < len__7511__auto___20764)){
args20761.push((arguments[i__7512__auto___20765]));

var G__20766 = (i__7512__auto___20765 + (1));
i__7512__auto___20765 = G__20766;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args20761.length)].join('')));
...
return cljs.core.first.call(null,cljs.core.reduce.call(null,(function (p__20772,p__20773){
var vec__20774 = p__20772;
var result = cljs.core.nth.call(null,vec__20774,(0),null);
var seen = cljs.core.nth.call(null,vec__20774,(1),null);
var vec__20775 = p__20773;
var k = cljs.core.nth.call(null,vec__20775,(0),null);
var v = cljs.core.nth.call(null,vec__20775,(1),null);
...
reepl.replumb.get_matching_ns_interns = (function reepl$replumb$get_matching_ns_interns(p__20777,matches_QMARK_,only_ns){
var vec__20779 = p__20777;
var name = cljs.core.nth.call(null,vec__20779,(0),null);
var ns = cljs.core.nth.call(null,vec__20779,(1),null);
...
return cljs.core.sort.call(null,cljs.core.map.call(null,((function (ns_name,publics,publics__$1,vec__20779,name,ns){
return (function (p1__20776_SHARP_){
return cljs.core.symbol.call(null,name,[cljs.core.str(p1__20776_SHARP_)].join(''));
});})(ns_name,publics,publics__$1,vec__20779,name,ns))
...
return [cljs.core.str("js/"),cljs.core.str(clojure.string.join.call(null,".",cljs.core.conj.call(null,cljs.core.vec.call(null,cljs.core.butlast.call(null,parts)),p1__20780_SHARP_)))].join('');
});})(parts,completing))
;
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,prefix.call(null,p1__20782_SHARP_),prefix.call(null,p1__20782_SHARP_)], null);
...
return !(cljs.core._EQ_.call(null,(-1),p1__20781_SHARP_.indexOf(completing)));
});})(parts,completing,prefix,possibles))
,possibles)));
});
/**
...
var vec__20789 = ((!(cljs.core._EQ_.call(null,(-1),text.indexOf("/"))))?text.split("/"):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,text], null));
var only_ns = cljs.core.nth.call(null,vec__20789,(0),null);
var text__$1 = cljs.core.nth.call(null,vec__20789,(1),null);
var matches_QMARK_ = ((function (vec__20789,only_ns,text__$1){
return (function (p1__20783_SHARP_){
return (cljs.core._EQ_.call(null,(-1),[cljs.core.str(p1__20783_SHARP_)].join('').indexOf("t_cljs$core"))) && (((-1) < [cljs.core.str(p1__20783_SHARP_)].join('').indexOf(text__$1)));
});})(vec__20789,only_ns,text__$1))
;
var current_ns = replumb.repl.current_ns.call(null);
var replace_name = ((function (vec__20789,only_ns,text__$1,matches_QMARK_,current_ns){
return (function (sym){
...
});})(vec__20789,only_ns,text__$1,matches_QMARK_,current_ns))
;
...
var defs = cljs.core.sort_by.call(null,((function (vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names){
return (function (p1__20786_SHARP_){
return cljs.core.get.call(null,p1__20786_SHARP_,(3));
});})(vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names))
,cljs.core.partial.call(null,reepl.replumb.compare_completion,text__$1),cljs.core.map.call(null,((function (vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names){
return (function (p1__20785_SHARP_){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20785_SHARP_,[cljs.core.str(p1__20785_SHARP_)].join(''),replace_name.call(null,p1__20785_SHARP_),cljs.core.name.call(null,p1__20785_SHARP_)], null);
});})(vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names))
,cljs.core.mapcat.call(null,((function (vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names){
return (function (p1__20784_SHARP_){
return reepl.replumb.get_matching_ns_interns.call(null,p1__20784_SHARP_,matches_QMARK_,only_ns__$1);
});})(vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names))
...
return cljs.core.vec.call(null,cljs.core.concat.call(null,cljs.core.take.call(null,(75),defs),cljs.core.map.call(null,((function (vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names,defs){
return (function (p1__20787_SHARP_){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20787_SHARP_,[cljs.core.str(p1__20787_SHARP_)].join(''),[cljs.core.str(p1__20787_SHARP_)].join('')], null);
});})(vec__20789,only_ns,text__$1,matches_QMARK_,current_ns,replace_name,requires,only_ns__$1,requires__$1,names,defs))
...
var seq__20800 = cljs.core.seq.call(null,new cljs.core.Keyword(null,"methods","methods",453930866).cljs$core$IFn$_invoke$arity$1(doc));
var chunk__20801 = null;
var count__20802 = (0);
var i__20803 = (0);
while(true){
if((i__20803 < count__20802)){
var vec__20804 = cljs.core._nth.call(null,chunk__20801,i__20803);
var name = cljs.core.nth.call(null,vec__20804,(0),null);
var map__20805 = cljs.core.nth.call(null,vec__20804,(1),null);
...
var doc__$1 = cljs.core.get.call(null,map__20805__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var arglists = cljs.core.get.call(null,map__20805__$1,new cljs.core.Keyword(null,"arglists","arglists",1661989754));
...
var G__20810 = seq__20800;
var G__20811 = chunk__20801;
var G__20812 = count__20802;
var G__20813 = (i__20803 + (1));
seq__20800 = G__20810;
chunk__20801 = G__20811;
count__20802 = G__20812;
i__20803 = G__20813;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__20800);
if(temp__4425__auto__){
var seq__20800__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20800__$1)){
var c__7256__auto__ = cljs.core.chunk_first.call(null,seq__20800__$1);
var G__20814 = cljs.core.chunk_rest.call(null,seq__20800__$1);
var G__20815 = c__7256__auto__;
var G__20816 = cljs.core.count.call(null,c__7256__auto__);
var G__20817 = (0);
seq__20800 = G__20814;
chunk__20801 = G__20815;
count__20802 = G__20816;
i__20803 = G__20817;
continue;
} else {
var vec__20807 = cljs.core.first.call(null,seq__20800__$1);
var name = cljs.core.nth.call(null,vec__20807,(0),null);
var map__20808 = cljs.core.nth.call(null,vec__20807,(1),null);
...
var doc__$1 = cljs.core.get.call(null,map__20808__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var arglists = cljs.core.get.call(null,map__20808__$1,new cljs.core.Keyword(null,"arglists","arglists",1661989754));
cljs.core.println.call(null);
...
var G__20818 = cljs.core.next.call(null,seq__20800__$1);
var G__20819 = null;
var G__20820 = (0);
var G__20821 = (0);
seq__20800 = G__20818;
chunk__20801 = G__20819;
count__20802 = G__20820;
i__20803 = G__20821;
continue;
}
} else {
...
var _STAR_print_newline_STAR_20824_20826 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_20825_20827 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_20824_20826,_STAR_print_fn_STAR_20825_20827,sb__7427__auto__){
return (function (x__7428__auto__){
return sb__7427__auto__.append(x__7428__auto__);
});})(_STAR_print_newline_STAR_20824_20826,_STAR_print_fn_STAR_20825_20827,sb__7427__auto__))
;

try{reepl.replumb.print_doc.call(null,reepl.replumb.doc_from_sym.call(null,sym));
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_20825_20827;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_20824_20826;
}
