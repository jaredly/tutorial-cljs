...
var vec__20835 = clojure.string.split.call(null,line,":");
...
if(cljs.core.not.call(null,reepl.show_devtools.js_array_QMARK_.call(null,p1__20836_SHARP_))){
return p1__20836_SHARP_;
} else {
return reepl$show_devtools$show_el.call(null,p1__20836_SHARP_,show_value);
}
});})(type,opts,children))
,children));
}
...
}catch (e20838){if((e20838 instanceof Error)){
var e = e20838;
return e;
} else {
throw e20838;
