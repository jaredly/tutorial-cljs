...
return true;
}catch (e18279){if((e18279 instanceof Error)){
var _ = e18279;
return false;
} else {
throw e18279;
...
var map__18282 = cljs.core.deref.call(null,state);
...
while (G__18285__i < G__18285__a.length) {G__18285__a[G__18285__i] = arguments[G__18285__i + 0]; ++G__18285__i;}
  args = new cljs.core.IndexedSeq(G__18285__a,0);
} 
...
while (G__18288__i < G__18288__a.length) {G__18288__a[G__18288__i] = arguments[G__18288__i + 0]; ++G__18288__i;}
  args = new cljs.core.IndexedSeq(G__18288__a,0);
} 
 ...
 */
reepl.core.repl_hint = (function reepl$core$repl_hint(complete_word,p__18290,options){
var map__18293 = p__18290;
...
var start = cljs.core.get.call(null,map__18293__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var end = cljs.core.get.call(null,map__18293__$1,new cljs.core.Keyword(null,"end","end",-268185958));
var text = cljs.core.get.call(null,map__18293__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
 ...
 *  to cycle through.
 */
reepl.core.cycle_completions = (function reepl$core$cycle_completions(p__18295,go_back_QMARK_,cm,evt){
var map__18299 = p__18295;
var map__18299__$1 = ((((!((map__18299 == null)))?((((map__18299.cljs$lang$protocol_mask$partition0$ & (64))) || (map__18299.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18299):map__18299);
var state = map__18299__$1;
var num = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"num","num",1985240673));
var pos = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
var active = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var from = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"from","from",1815293044));
var to = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"to","to",192099007));
var list = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"list","list",765357683));
var initial_text = cljs.core.get.call(null,map__18299__$1,new cljs.core.Keyword(null,"initial-text","initial-text",1211686190));
...
var vec__18301 = (cljs.core.truth_(active)?reepl.core.cycle_pos.call(null,num,pos,go_back_QMARK_,initial_active):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,(cljs.core.truth_(go_back_QMARK_)?(num - (1)):pos)], null));
var active__$1 = cljs.core.nth.call(null,vec__18301,(0),null);
var pos__$1 = cljs.core.nth.call(null,vec__18301,(1),null);
...
}),new cljs.core.Keyword(null,"set","set",304602554),(function (p1__18302_SHARP_){
return cljs.core.reset_BANG_.call(null,complete_atom,reepl.core.repl_hint.call(null,complete_word,p1__18302_SHARP_,null));
}),new cljs.core.Keyword(null,"cycle","cycle",710365284),(function (p1__18303_SHARP_,p2__18304_SHARP_,p3__18305_SHARP_){
return cljs.core.swap_BANG_.call(null,complete_atom,reepl.core.cycle_completions,p1__18303_SHARP_,p2__18304_SHARP_,p3__18305_SHARP_);
})], null);
});
reepl.core.repl = (function reepl$core$repl(var_args){
var args__7518__auto__ = [];
var len__7511__auto___18319 = arguments.length;
var i__7512__auto___18320 = (0);
while(true){
if((i__7512__auto___18320 < len__7511__auto___18319)){
args__7518__auto__.push((arguments[i__7512__auto___18320]));

var G__18321 = (i__7512__auto___18320 + (1));
i__7512__auto___18320 = G__18321;
continue;
} else {
}
break;
...
reepl.core.repl.cljs$core$IFn$_invoke$arity$variadic = (function (p__18309){
...
var execute = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"execute","execute",-129499188));
var complete_word = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"complete-word","complete-word",1063206084));
var get_docs = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"get-docs","get-docs",-698720007));
var state = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var complete_atom = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"complete-atom","complete-atom",-243286874));
var show_value_opts = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"show-value-opts","show-value-opts",-412296519));
var js_cm_opts = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"js-cm-opts","js-cm-opts",1231776640));
var on_cm_init = cljs.core.get.call(null,map__18310__$1,new cljs.core.Keyword(null,"on-cm-init","on-cm-init",105207782));
...
var map__18312 = reepl.core.make_handlers.call(null,state__$1);
...
var add_input = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"add-input","add-input",-994386222));
var add_result = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"add-result","add-result",1382794315));
var go_up = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"go-up","go-up",-783282342));
var go_down = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"go-down","go-down",-1002511595));
var clear_items = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"clear-items","clear-items",524826180));
var set_text = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"set-text","set-text",1346789745));
var add_log = cljs.core.get.call(null,map__18312__$1,new cljs.core.Keyword(null,"add-log","add-log",1433037691));
...
var docs = reagent.ratom.make_reaction.call(null,((function (state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init){
return (function (){
var map__18314 = cljs.core.deref.call(null,complete_atom__$1);
var map__18314__$1 = ((((!((map__18314 == null)))?((((map__18314.cljs$lang$protocol_mask$partition0$ & (64))) || (map__18314.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18314):map__18314);
var state__$2 = map__18314__$1;
var pos = cljs.core.get.call(null,map__18314__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
var list = cljs.core.get.call(null,map__18314__$1,new cljs.core.Keyword(null,"list","list",765357683));
...
});})(state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init))
);
var submit = ((function (state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,docs,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init){
...
return execute.call(null,text,((function (state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,docs,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init){
return (function (p1__18306_SHARP_,p2__18307_SHARP_){
return add_result.call(null,cljs.core.not.call(null,p1__18306_SHARP_),p2__18307_SHARP_);
});})(state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,docs,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init))
);
} else {
return null;
}
...
return ((function (state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,docs,submit,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init){
return (function() { 
var G__18322__delegate = function (p__18316){
...
var execute__$1 = cljs.core.get.call(null,map__18317__$1,new cljs.core.Keyword(null,"execute","execute",-129499188));
var get_docs__$1 = cljs.core.get.call(null,map__18317__$1,new cljs.core.Keyword(null,"get-docs","get-docs",-698720007));
var state__$2 = cljs.core.get.call(null,map__18317__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var show_value_opts__$1 = cljs.core.get.call(null,map__18317__$1,new cljs.core.Keyword(null,"show-value-opts","show-value-opts",-412296519));
var js_cm_opts__$1 = cljs.core.get.call(null,map__18317__$1,new cljs.core.Keyword(null,"js-cm-opts","js-cm-opts",1231776640));
var on_cm_init__$1 = cljs.core.get.call(null,map__18317__$1,new cljs.core.Keyword(null,"on-cm-init","on-cm-init",105207782));
...
while (G__18323__i < G__18323__a.length) {G__18323__a[G__18323__i] = arguments[G__18323__i + 0]; ++G__18323__i;}
  p__18316 = new cljs.core.IndexedSeq(G__18323__a,0);
} 
return G__18322__delegate.call(this,p__18316);};
G__18322.cljs$lang$maxFixedArity = 0;
G__18322.cljs$lang$applyTo = (function (arglist__18324){
var p__18316 = cljs.core.seq(arglist__18324);
return G__18322__delegate(p__18316);
});
G__18322.cljs$core$IFn$_invoke$arity$variadic = G__18322__delegate;
return G__18322;
})()
;
;})(state__$1,complete_atom__$1,map__18312,map__18312__$1,add_input,add_result,go_up,go_down,clear_items,set_text,add_log,items,complete_cmd,docs,submit,map__18310,map__18310__$1,execute,complete_word,get_docs,state,complete_atom,show_value_opts,js_cm_opts,on_cm_init))
});

reepl.core.repl.cljs$lang$maxFixedArity = (0);

reepl.core.repl.cljs$lang$applyTo = (function (seq18308){
return reepl.core.repl.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18308));
});
