...
var args16208 = [];
var len__7511__auto___16212 = arguments.length;
var i__7512__auto___16213 = (0);
while(true){
if((i__7512__auto___16213 < len__7511__auto___16212)){
args16208.push((arguments[i__7512__auto___16213]));

var G__16214 = (i__7512__auto___16213 + (1));
i__7512__auto___16213 = G__16214;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___16216 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__16207_SHARP_){
if(!((p1__16207_SHARP_ == null))){
if((false) || (p1__16207_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___16216){
var not_reactive_16217 = temp__4425__auto___16216;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_16217);
} else {
}
} else {
}
