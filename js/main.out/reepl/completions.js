...
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__12806){
var vec__12807 = p__12806;
var _ = cljs.core.nth.call(null,vec__12807,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__12807,(1),null);
var old_is_selected = cljs.core.nth.call(null,vec__12807,(2),null);
var vec__12808 = reagent.core.argv.call(null,this$);
var ___$2 = cljs.core.nth.call(null,vec__12808,(0),null);
var ___$3 = cljs.core.nth.call(null,vec__12808,(1),null);
var is_selected__$1 = cljs.core.nth.call(null,vec__12808,(2),null);
...
reepl.completions.completion_list = (function reepl$completions$completion_list(p__12811,set_active){
var map__12814 = p__12811;
var map__12814__$1 = ((((!((map__12814 == null)))?((((map__12814.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12814.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12814):map__12814);
var pos = cljs.core.get.call(null,map__12814__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
var list = cljs.core.get.call(null,map__12814__$1,new cljs.core.Keyword(null,"list","list",765357683));
var active = cljs.core.get.call(null,map__12814__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var show_all = cljs.core.get.call(null,map__12814__$1,new cljs.core.Keyword(null,"show-all","show-all",715701051));
var items = cljs.core.map_indexed.call(null,((function (map__12814,map__12814__$1,pos,list,active,show_all){
return (function (p1__12810_SHARP_,p2__12809_SHARP_){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reepl.completions.completion_item,cljs.core.get.call(null,p2__12809_SHARP_,(2)),cljs.core._EQ_.call(null,p1__12810_SHARP_,pos),active,cljs.core.partial.call(null,set_active,p1__12810_SHARP_)], null);
});})(map__12814,map__12814__$1,pos,list,active,show_all))
,list);
