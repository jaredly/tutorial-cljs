...
var vec__19862 = clojure.string.split.call(null,line,":");
...
if(cljs.core.not.call(null,reepl.show_devtools.js_array_QMARK_.call(null,p1__19863_SHARP_))){
return p1__19863_SHARP_;
} else {
return reepl$show_devtools$show_el.call(null,p1__19863_SHARP_,show_value);
}
});})(type,opts,children))
,children));
}
