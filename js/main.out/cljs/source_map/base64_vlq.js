...
var digit_12679 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_12680__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_12680__$1 > (0))){
var digit_12681__$1 = (digit_12679 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_12681__$1));

var G__12682 = (vlq_12680__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__12683 = (vlq_12680__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_12679 = G__12682;
vlq_12680__$1 = G__12683;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_12679));
}
break;
}
...
var G__12684 = i__$1;
var G__12685 = result__$1;
var G__12686 = shift__$1;
i = G__12684;
result = G__12685;
shift = G__12686;
continue;
