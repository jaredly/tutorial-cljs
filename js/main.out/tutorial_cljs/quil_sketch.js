...
var sketch = quil.sketch.make_sketch.call(null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"title","title",636505583),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"setup","setup",1987730512),((function (opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1){
return (function (){
var new_applet = quil.sketch.current_applet.call(null);
cljs.core.swap_BANG_.call(null,tutorial_cljs.quil_sketch.applets,cljs.core.update,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(opts),((function (new_applet,opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1){
return (function (old){
...
});})(new_applet,opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1))
);

cljs.core.reset_BANG_.call(null,tutorial_cljs.quil_sketch.current_applet,new_applet);

setTimeout(((function (new_applet,opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1){
return (function (){
...
});})(opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1))
...
reagent.core.render.call(null,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [tutorial_cljs.quil_sketch.mobile_sketch,[cljs.core.str(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(opts))].join(''),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(opts),pos_atom,((function (opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1,sketch){
return (function (p1__21119_SHARP_){
return (new Processing(p1__21119_SHARP_,sketch));
});})(opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1,sketch))
,((function (opts,old_data,_,vec__21121,width,height,node,pos_atom,___$1,sketch){
return (function (){
