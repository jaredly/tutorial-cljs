...
tutorial_cljs.quil_sketch.canvas = (function tutorial_cljs$quil_sketch$canvas(p__21086,on_canvas){
var vec__21088 = p__21086;
var width = cljs.core.nth.call(null,vec__21088,(0),null);
var height = cljs.core.nth.call(null,vec__21088,(1),null);
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (vec__21088,width,height){
return (function (this$){
return on_canvas.call(null,reagent.core.dom_node.call(null,this$));
});})(vec__21088,width,height))
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (vec__21088,width,height){
return (function (){
...
var map__21100 = cljs.core.deref.call(null,pos_atom);
var map__21100__$1 = ((((!((map__21100 == null)))?((((map__21100.cljs$lang$protocol_mask$partition0$ & (64))) || (map__21100.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21100):map__21100);
var left = cljs.core.get.call(null,map__21100__$1,new cljs.core.Keyword(null,"left","left",-399115937));
var top = cljs.core.get.call(null,map__21100__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
...
var move_listener = ((function (map__21100,map__21100__$1,left,top,state){
return (function (evt){
evt.preventDefault();

return cljs.core.swap_BANG_.call(null,state,((function (map__21100,map__21100__$1,left,top,state){
return (function (p__21102){
...
var state__$1 = map__21103__$1;
var dx = cljs.core.get.call(null,map__21103__$1,new cljs.core.Keyword(null,"dx","dx",-381796732));
var dy = cljs.core.get.call(null,map__21103__$1,new cljs.core.Keyword(null,"dy","dy",1719547243));
...
});})(map__21100,map__21100__$1,left,top,state))
);
});})(map__21100,map__21100__$1,left,top,state))
;
var up_listener = ((function (map__21100,map__21100__$1,left,top,state,move_listener){
return (function tutorial_cljs$quil_sketch$mobile_sketch_$_up_listener(evt){
var map__21107_21111 = cljs.core.deref.call(null,state);
var map__21107_21112__$1 = ((((!((map__21107_21111 == null)))?((((map__21107_21111.cljs$lang$protocol_mask$partition0$ & (64))) || (map__21107_21111.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21107_21111):map__21107_21111);
var top_21113__$1 = cljs.core.get.call(null,map__21107_21112__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
var left_21114__$1 = cljs.core.get.call(null,map__21107_21112__$1,new cljs.core.Keyword(null,"left","left",-399115937));
cljs.core.swap_BANG_.call(null,pos_atom,cljs.core.assoc,new cljs.core.Keyword(null,"top","top",-1856271961),top_21113__$1,new cljs.core.Keyword(null,"left","left",-399115937),left_21114__$1);
...
});})(map__21100,map__21100__$1,left,top,state,move_listener))
;
return ((function (map__21100,map__21100__$1,left,top,state,move_listener,up_listener){
return (function (){
var map__21109 = cljs.core.deref.call(null,state);
...
});})(map__21109,map__21109__$1,top__$1,left__$1,moving,map__21100,map__21100__$1,left,top,state,move_listener,up_listener))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"play-pause-button","play-pause-button",-1603575885).cljs$core$IFn$_invoke$arity$1(tutorial_cljs.quil_sketch.styles),new cljs.core.Keyword(null,"title","title",636505583),"Play/Pause",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__21109,map__21109__$1,top__$1,left__$1,moving,map__21100,map__21100__$1,left,top,state,move_listener,up_listener){
return (function (){
...
var vec__21121 = new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(opts);
var width = cljs.core.nth.call(null,vec__21121,(0),null);
var height = cljs.core.nth.call(null,vec__21121,(1),null);
...
var sketch = quil.sketch.make_sketch.call(null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"title","title",636505583),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"setup","setup",1987730512),((function (opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1){
return (function (){
...
(new_applet["loop"] = ((function (new_applet,old_loop,old_no_loop,opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1){
return (function (){
cljs.core.reset_BANG_.call(null,loop_atom,true);

return old_loop.call(null);
});})(new_applet,old_loop,old_no_loop,opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1))
);

(new_applet["noLoop"] = ((function (new_applet,old_loop,old_no_loop,opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1){
return (function (){
...
cljs.core.swap_BANG_.call(null,tutorial_cljs.quil_sketch.applets,cljs.core.update,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(opts),((function (new_applet,old_loop,old_no_loop,opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1){
return (function (old){
...
cljs.core.add_watch.call(null,loop_atom,new cljs.core.Keyword(null,"wat","wat",1561347706),((function (new_applet,old_loop,old_no_loop,opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1){
...
setTimeout(((function (new_applet,old_loop,old_no_loop,opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1){
return (function (){
...
});})(opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1))
...
reagent.core.render.call(null,new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [tutorial_cljs.quil_sketch.mobile_sketch,[cljs.core.str(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(opts))].join(''),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(opts),new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(opts),loop_atom,pos_atom,((function (opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1,sketch){
return (function (p1__21119_SHARP_){
return (new Processing(p1__21119_SHARP_,sketch));
});})(opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1,sketch))
,((function (opts,old_data,_,vec__21121,width,height,node,pos_atom,loop_atom,___$1,sketch){
return (function (){
...
var temp__4425__auto___21122__$1 = new cljs.core.Keyword(null,"node","node",581201198).cljs$core$IFn$_invoke$arity$1(data).parentNode;
if(cljs.core.truth_(temp__4425__auto___21122__$1)){
var parent_21123 = temp__4425__auto___21122__$1;
parent_21123.removeChild(new cljs.core.Keyword(null,"node","node",581201198).cljs$core$IFn$_invoke$arity$1(data));
} else {
}
