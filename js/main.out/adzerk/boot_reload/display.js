...
return (function (p__12921){
var vec__12922 = p__12921;
var attr = cljs.core.nth.call(null,vec__12922,(0),null);
...
var args12923 = [];
var len__7511__auto___12926 = arguments.length;
var i__7512__auto___12927 = (0);
while(true){
if((i__7512__auto___12927 < len__7511__auto___12926)){
args12923.push((arguments[i__7512__auto___12927]));

var G__12928 = (i__7512__auto___12927 + (1));
i__7512__auto___12927 = G__12928;
continue;
} else {
}
break;
...
var len__7511__auto___12931 = arguments.length;
var i__7512__auto___12932 = (0);
while(true){
if((i__7512__auto___12932 < len__7511__auto___12931)){
args__7518__auto__.push((arguments[i__7512__auto___12932]));

var G__12933 = (i__7512__auto___12932 + (1));
i__7512__auto___12932 = G__12933;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq12930){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12930));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__12934){
var map__12938 = p__12934;
...
var data = map__12938__$1;
var message = cljs.core.get.call(null,map__12938__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__12938__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12938__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__12940 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__12940,goog.events.EventType.CLICK,((function (G__12940,map__12938,map__12938__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__12940,map__12938,map__12938__$1,data,message,line,file))
);

return G__12940;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__12941){
var map__12945 = p__12941;
var map__12945__$1 = ((((!((map__12945 == null)))?((((map__12945.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12945.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12945):map__12945);
var data = map__12945__$1;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__12948){
var map__12952 = p__12948;
var map__12952__$1 = ((((!((map__12952 == null)))?((((map__12952.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12952.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12952):map__12952);
var messages = map__12952__$1;
var warnings = cljs.core.get.call(null,map__12952__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__12952__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__12954 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__12954,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__12954,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__12955){
var map__12958 = p__12955;
...
var messages = map__12958__$1;
var warnings = cljs.core.get.call(null,map__12958__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__12958__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__12958,map__12958__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__12958,map__12958__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__12958,map__12958__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__12958,map__12958__$1,messages,warnings,exception))
;
...
}catch (e12961){if((e12961 instanceof Error)){
var __12962 = e12961;
} else {
throw e12961;
