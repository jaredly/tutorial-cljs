...
return cljs.core.merge.call(null,initial_state,p1__21059_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_21060 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_21061 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_21060);
var pos_21062 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_21060);
quil.core.scale.call(null,zoom_21061);

var tr__20983__auto___21063 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_21061) - cljs.core.first.call(null,pos_21062)),(((quil.core.height.call(null) / (2)) / zoom_21061) - cljs.core.second.call(null,pos_21062))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__20983__auto___21063);
